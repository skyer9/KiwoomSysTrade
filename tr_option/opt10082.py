...
class Opt10082(KWTR):
    ...
    def __init__(self, core):
        ...
        self.tr_code = 'opt10082'
        self.rq_name = '주식주봉차트조회요청'

        self.record_name_single = '주식주봉차트'
        self.header_single = [
            '종목코드',
        ]

        self.record_name_multiple = '주식주봉차트조회'
    ...
    def tr_opt(self, code, date_from, date_to, input3, prev_next, screen_no):
        # 종목코드 = 전문 조회할 종목코드
        # 기준일자 = YYYYMMDD (20160101 연도4자리, 월 2자리, 일 2자리 형식)
        # SetInputValue("끝일자"	,  "입력값 3");
